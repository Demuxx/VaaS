...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { box_id: @machine.box_id, description: @machine.description, key_id: @machine.key_id, name: @machine.name, network_id: @machine.network_id, status_id: @machine.status_id }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { box_id: @machine.box_id, description: @machine.description, key_id: @machine.key_id, name: @machine.name, network_id: @machine.network_id, status_id: @machine.status_id }
    assert_redirected_to machine_path(assigns(:machine))
  end
